<?php 
    echo "
          ...
          echo "
                  ...
                  <tbody>
                    <tr><th width='120px' scope='row'>Username</th>   
                    ...
                    <tr><th scope='row'>Telepon</th>               
                          <td><input type='number' class='form-control' name='e' required></td>
                    </tr>
                    <tr><th scope='row'>Upload Foto</th>              
                          <td><input type='file' class='form-control' name='f'></td>
                    </tr>
                    <tr><th scope='row'>Level</th>                   
                          <td><input type='radio' name='g' value='kontributor' checked> admin &nbsp; <input type='radio' name='g' value='user'> User &nbsp; <input type='radio' name='g' value='admin'> Super Admin
                    <tr><th scope='row'>Akses Modul</th>                    
