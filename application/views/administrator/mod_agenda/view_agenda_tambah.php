          ...
          echo "
                  <table class='table table-sm table-borderless'>
                    <tbody>
                      ...
                      <tr><th scope='row'>Rincian Event</th>           
                          <td><textarea id='editor1' class='form-control' name='b' style='height:260px'></textarea></td>
                      </tr>
                      ...
                      <tr><th scope='row'>Tgl <small>s/d</small> Selesai</th>
                          <td><input type='text' class='form-control' id='rangepicker' name='f' autocomplete='off'></td>
                      </tr>
